        ...
        >
          ...
          {sourceMode && (
            <textarea
              ...
              className="min-h-[60vh] w-full resize-y rounded border border-line bg-canvas p-3 font-mono text-sm text-ink-soft focus:outline-none focus-visible:outline-none"
              spellCheck={false}
              autoCapitalize="off"
              autoCorrect="off"
              value={sourceText}
